...
public class jazz_integration extends AppCompatActivity {
    String postData = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("Nha collection: price_before : " +price);

        String[] values = price.split("\\.");
        price = values[0];
        price = price + "00";
        System.out.println("Nha collection: price : " +price);

        Date Date = new Date();
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyyMMddkkmmss");
        String DateString = dateFormat.format(Date);
        System.out.println("Nha collection: DateString : " +DateString);
        ...
        System.out.println("Nha collection: expiryDateString : " +expiryDateString);

        String TransactionIdString = "T" + DateString;
        System.out.println("Nha collection: TransactionIdString : " +TransactionIdString);
        ...
        pp_SecureHash = php_hash_hmac(sortedString, IntegritySalt);
        System.out.println("Nha collection: sortedString : " +sortedString);
        System.out.println("Nha collection: pp_SecureHash : " +pp_SecureHash);
        ...
        System.out.println("Nha collection: postData : " +postData);
    ...
    private class MyWebViewClient extends WebViewClient {
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            if(url.equals(paymentReturnUrl)){
                System.out.println("Nha collection: return url cancelling");
                view.stopLoading();
                return;
            }
    ...
    private class FormDataInterface {
        ...
        public void processFormData(String url, String formData) {
            Intent i = new Intent(jazz_integration.this, Jazz_main.class);

            System.out.println("Nha collection: Url:" + url + " form data " + formData);
            if (url.equals(paymentReturnUrl)) {
                String[] values = formData.split("&");
                for (String pair : values) {
                    String[] nameValue = pair.split("=");
                    if (nameValue.length == 2) {
                        System.out.println("Nha collection: Name:" + nameValue[0] + " value:" + nameValue[1]);
